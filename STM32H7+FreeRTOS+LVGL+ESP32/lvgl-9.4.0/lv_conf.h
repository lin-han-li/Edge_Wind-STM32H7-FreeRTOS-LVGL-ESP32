 ...
 */
/* NOTE:
 * LVGL v9 uses lv_strndup() (-> lv_strnlen()) in more places (e.g. draw tasks with text_local=true).
 * On some Keil MICROLIB setups, strnlen() can behave unexpectedly, causing copied strings to become empty.
 * Use LVGL's built-in string functions for correctness.
 */
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /* [Memory] Increased to 2MB for SDRAM usage */
    ...
    /* [Memory] Mapped to External SDRAM with 4MB offset */
 ...
 * - LV_OS_SDL2
 * - LV_OS_CUSTOM */
/* [Tick] OS set to NONE, so you must call lv_tick_inc() in your ISR */
 ...
 * DEMO USAGE
 ====================*/
    ...
    /* [Optimization] Enabled for benchmark testing */
