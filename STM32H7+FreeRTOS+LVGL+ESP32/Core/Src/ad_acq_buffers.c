...
float ADSA_AUX4[AD_AUX4_COUNT] = {67.8480f, 55.7832f, 49.2850f, 3016.0754f};
float ADSA_AUX4_2[AD_AUX4_COUNT] = {67.8480f, 55.7832f, 49.2850f, 3016.0754f};
float ADS131A04_Buf[4] = {0};

volatile uint16_t AD7606_DebugRaw[8] = {0};
volatile float AD7606_DebugVolts[8] = {0};
volatile float AD7606_Aux4Values[AD_AUX4_COUNT] = {67.8480f, 55.7832f, 49.2850f, 3016.0754f};
