...
#define W25Qxx_CMD_ReadStatus_REG2	0x35		// 读状态寄存器2（QE 位在 SR2）
#define W25Qxx_CMD_WriteStatus_REG1	0x01		// 写状态寄存器1（同时可写 SR1+SR2）
...
#define W25Qxx_Status_REG2_QE				0x02			// 状态寄存器2 QE(Quad Enable) 位（不同批次器件可能默认=0）
